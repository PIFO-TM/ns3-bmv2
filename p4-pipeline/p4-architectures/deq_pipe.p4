...
/* P4-16 declaration of the PifoTree classification pipeline */

#ifndef _DEQ_PIPE_P4_
#define _DEQ_PIPE_P4_
...
struct standard_metadata_t {
    ...
    bit<32> pifo2_rank;
    bit<64> pifo2_tx_time;
    bit<32> pifo2_tx_delta;
    bit<32> pifo2_pkt_len;
    //
    // Outputs
    //
    bit<8> pifo_id;
