...
NS_LOG_COMPONENT_DEFINE ("LasTest");
...
std::vector<int> flowRates = {10, 10, 10}; // Mbps
std::vector<double> appStartTimes = {0.0, 1.0, 1.5};
std::vector<int> flowSizes = {4000000, 2000000, 500000}; // 4MB, 2MB, 500KB
std::string pathOut = ".";
std::string jsonFile = "";
...
{
  LogComponentEnable ("LasTest", LOG_LEVEL_INFO);
